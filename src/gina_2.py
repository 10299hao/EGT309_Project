...
# -------------------------------------------------------
# Standalone execution only — does NOT run on import
# -------------------------------------------------------
if __name__ == "__main__":
    ...
    sns.countplot(x='Activity Level', data=df, order=['Low Activity', 'Moderate Activity', 'High Activity'],
                  hue='Activity Level', palette='viridis', legend=False)
    ...
    sns.boxplot(x='Activity Level', y='Temperature', data=df,
                hue='Activity Level', palette='Set2', legend=False)
    ...
    core_feature_processor = ColumnTransformer(transformers=[
